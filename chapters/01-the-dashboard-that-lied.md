...
| | $P(Y \mid X)$ — observation | $P(Y \mid do(X))$ — intervention |
|---|---|---|
...
| | Mechanical silent failure | Epistemic silent failure |
|---|---|---|
...
| System type | Causal structure | Counterfactual reasoning | Continuous updating | Treatment orientation |
|---|---|---|---|---|
