...
| | **Property** | **Value** |
|---|---|---|
| **Physics → Finance (physics envy)** | _fill in_ | _fill in_ |
| **Engineering → Medicine (device reliability → patient outcomes)** | _fill in_ | _fill in_ |
| **Economics → Ecology** | _fill in_ | _fill in_ |
| **Military → Business strategy** | _fill in_ | _fill in_ |
...
| | **Kind** | **Interrogate formally); purpose is to make the kind/wicked distinction concrete across domains the book's audience will recognize** |
|---|---|---|
| **Diagnostic clinical reasoning** | _fill in_ | _fill in_ |
| **Prognostic clinical reasoning** | _fill in_ | _fill in_ |
| **Chess** | _fill in_ | _fill in_ |
| **Macroeconomic forecasting** | _fill in_ | _fill in_ |
| **Supply chain operations** | _fill in_ | _fill in_ |
| **Strategic management** | _fill in_ | _fill in_ |
