...
| limit | what the system cannot do | what provides the protection | when to augment with human judgment — rows: (1) Expert model correctness: cannot detect substantive error not caused by known bias / Chapter 17 data-driven refinement tests diagram against observational data / when the diagram conflicts with data in multiple places |
| --- | --- | --- | --- |
| Limits | Connects limits to the chapter's main distinction | Shows the consequence of limits in practice | Connects limits to the chapter's main distinction |
| Limit | Connects limit to the chapter's main distinction | Shows the consequence of limit in practice | Connects limit to the chapter's main distinction |
| System | Connects system to the chapter's main distinction | Shows the consequence of system in practice | Connects system to the chapter's main distinction |
